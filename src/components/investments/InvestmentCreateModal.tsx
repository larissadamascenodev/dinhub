...
import { X, ChevronLeft, ChevronRight, Sparkles, Loader2, TrendingUp, Pencil, PiggyBank } from "lucide-react";
            ...
            <div className="flex items-center justify-between px-5 pt-4 pb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-primary">
                  {step === 0 ? "Novo Investimento" : step === 1 ? "Valor Inicial" : "Tudo Pronto"}
                </span>
              </div>
              ...
              <AnimatePresence mode="wait">
                ...
                {step === 1 && (
                  ...
                  >
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-foreground">Valor inicial</h2>
                      <p className="text-xs text-muted-foreground/60 mt-0.5">Quanto já tem investido nessa carteira? (pode ser 0)</p>
                    </div>
                ...
                {step === 2 && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                      ...
                      <div className="rounded-xl border border-border/10 bg-muted/5 px-4 py-3">
                        <p className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground/40">Carteira</p>
                        <p className="text-sm font-bold text-foreground mt-0.5 truncate">{investName}</p>
                      </div>
                    </div>
                  </motion.div>
                )}
