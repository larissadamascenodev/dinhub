...
const CategoriasTab: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-12 items-center min-w-0">
...
const ScannerTab: React.FC = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.05fr] gap-12 items-center min-w-0">
      <div className="min-w-0 w-full">
