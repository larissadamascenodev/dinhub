...
const Hero = ({ videoSrc }: HeroProps) => {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative w-full h-[100svh] min-h-[600px] bg-[#030303] overflow-hidden flex flex-col items-center justify-center font-sora pt-16 sm:pt-20 pb-20"
    >
      {/* Background Video */}
      {videoSrc && (
        <video
      ...
      <div
        ...
        className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 sm:gap-1.5 z-20"
      >
