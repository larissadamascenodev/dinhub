                  ...
                  <AnimatePresence>
                    {transacaoMenuOpen && (
                      <motion.div
                        ...
                        className="absolute left-1/2 -translate-x-1/2 top-full mt-3 z-50 flex gap-1.5 p-1.5 rounded-xl bg-card/95 backdrop-blur-2xl border border-border/15 shadow-2xl shadow-black/30"
                      >
                        <button
