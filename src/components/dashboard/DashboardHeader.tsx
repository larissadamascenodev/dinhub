                  ...
                  <AnimatePresence>
                    {transacaoMenuOpen && (
                      <motion.div
                        ...
                        className="fixed top-[70px] z-50 gap-1.5 p-1.5 rounded-xl bg-card/95 backdrop-blur-2xl border-border/15 shadow-2xl shadow-black/30 border border-none text-left ml-0 mt-0 mr-0 flex-row flex items-center justify-start"
                      >
                        <button
