                  ...
                  <AnimatePresence>
                    {transacaoMenuOpen && (
                      <motion.div
                        ...
                        className="fixed top-[70px] z-50 flex gap-1.5 p-1.5 rounded-xl bg-card/95 backdrop-blur-2xl border border-border/15 shadow-2xl shadow-black/30"
                        style={{ left: "calc(50% - 2px)", transform: "translateX(-50%)" }}
                      >
                        <button
