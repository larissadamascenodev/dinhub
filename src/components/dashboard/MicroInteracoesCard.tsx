...
const MicroInteracoesCard = memo(({ gastosHoje, mediaGastosDiarios }: Props) => {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden flex items-center gap-3 rounded-xl px-4 py-2.5 cursor-pointer transition-all border border-primary/10 shadow-[0_1px_4px_-1px_rgba(0,0,0,0.2),inset_0_1px_0_0_rgba(255,255,255,0.03)]"
